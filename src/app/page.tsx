...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const onboarded = localStorage.getItem("plate-onboarded");
  ...
  const streak = calcStreak(foodLog, calories);
  const weekly = calcWeeklySummary(foodLog, calories);
  ...
  function completeOnboarding(w: number, u: "kg" | "lb", p: Profile) {
    setWeight(w);
    setUnit(u);
    setProfile(p);
    setHasOnboarded(true);
    localStorage.setItem("plate-onboarded", "true");
  }
  ...
  return (
    <div className={`${body.className} min-h-screen bg-[#FBF8F2] text-[#1A1A16]`}>
      ...
      {!hasOnboarded ? (
        <>
          <section className="mx-auto max-w-6xl px-6 pt-16 pb-4 md:px-12">
        ...
        <>
          <section className="mx-auto grid max-w-6xl gap-8 px-6 pt-12 pb-8 md:grid-cols-2 md:px-12">
            ...
            <div className={`${mono.className} border-4 border-[#1A1A16] p-6`}>
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[10px] font-semibold uppercase tracking-wide text-[#8C8577] hover:text-[#E4572E]"
                >
                  {showProfileEditor ? "Hide" : "Edit profile"}
                </button>
              </div>
          ...
          <section className="mx-auto max-w-6xl px-6 pb-16 md:px-12">
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              ...
              <WeeklySummaryCard days={weekly.days} avgCalories={weekly.avgCalories} avgProtein={weekly.avgProtein} daysHit={weekly.daysHit} />
            </div>
          </section>
